      ...
      <div className="w-full px-8 mx-auto max-w-7xl">
        <div className="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="grid justify-between grid-cols-3 gap-4">
            ...
            <ul>
              <p className="block mb-1 text-base font-semibold text-slate-800">Quick Actions</p>
              <li>
                <Link to="/contact-us" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                  Contact us
                </Link>
              </li>
              <li>
                <Link to="/listings" className="block text-slate-600 py-1 hover:text-slate-500 focus:text-slate-500 text-sm">
                  Listings
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
          <p className="block mb-4 text-sm text-center text-slate-500 md:mb-0">
            ...
            <Link to="/" className="text-slate-500 hover:text-slate-600">QuickTrust - Services</Link>. All Rights Reserved.
          </p>
          <div className="flex gap-4 text-slate-600 sm:justify-center">
            ...
            <Link to="#" className="block transition-opacity text-inherit hover:opacity-80">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.02 4.111 4.111 0 01-1.784.068 4.105 4.105 0 003.843 2.86 8.23 8.23 0 01-5.107 1.766A11.597 11.597 0 008.29 20.25z"></path>
              </svg>
            </Link>
          </div>
        </div>
